...
aggregate_models = {
    ...
    "Mining & Utilities":
    "Aggregate_Mining_and_quarrying_Electricity_gas_and_water_supply",

    "Trade, Transport & Business":
    "Aggregate_Trade_Transportation_Accommodation_and_Food_and_Business_and_Administrative_Services",

    "Public & Community Services":
    "Aggregate_Public_Administration_Community_Social_and_other_Services_and_Activities"
...
if predict:
    ...
    forecast_y = [history["y"].iloc[-1]] + list(forecast)
    ...
    st.success(
        ...
        f"Forecast generated for {display_name} ({forecast_years} years)."
...
st.caption(
    ...
    "AfriWork | African Labour Market Intelligence Platform | ARIMA Forecasting"
)